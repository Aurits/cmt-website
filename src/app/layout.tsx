    ...
    <html lang="en-UG" suppressHydrationWarning>
      <body className={`${inter.variable} ${fraunces.variable}`} suppressHydrationWarning>
        ...
        */}
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-[2px] focus:bg-green focus:px-4 focus:py-2 focus:text-cream"
        >
          Skip to content
        </a>
