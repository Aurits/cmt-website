...
export const inputClass =
  'w-full rounded-[2px] border border-rule bg-paper px-3.5 py-3 text-[0.9375rem] text-ink placeholder:text-muted/60 transition-colors hover:border-green/40 focus:border-green';
