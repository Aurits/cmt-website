...
const base =
  'inline-flex items-center justify-center gap-2 rounded-brand font-medium transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-60';
